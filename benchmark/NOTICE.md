...
- Used for:
  - `benchmark/grammars/calc/grammar.peg`
  - `benchmark/grammars/json/grammar.peg`
  - `benchmark/grammars/kotlin/grammar.peg`
...
- Used for:
  - `benchmark/grammars/json/grammar.js`
...
- Used for:
  - `benchmark/grammars/kotlin/grammar.js`
