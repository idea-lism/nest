...
int main(int argc, char** argv) {
  ...
  Lex* scopes[] = {
      _build_main_scope(),   _build_vpa_scope(),    _build_peg_scope(),       _build_re_scope(),
      _build_re_str_scope(), _build_re_ref_scope(), _build_charclass_scope(), _build_keyword_str_scope(),
  };
